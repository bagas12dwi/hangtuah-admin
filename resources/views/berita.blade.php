                        ...
                        <tbody>
                            @foreach ($data as $data)
                                <tr>
                                    <td>
                                        <div class="my-auto">
                                            <img src="{{ asset('storage/berita/' . $data->imgPath) }}" width="100px"
                                                alt="" />
                                        </div>
                                    </td>
                                    <td>
                                    ...
                                    <td class="align-middle">
                                        <button data-bs-toggle="modal" data-bs-target="#editBerita{{ $data->id }}"
                                ...
                                <div class="modal fade" id="editBerita{{ $data->id }}" tabindex="-1" role="dialog"
